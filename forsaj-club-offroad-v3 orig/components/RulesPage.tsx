        ...
        <div className="lg:w-1/4 space-y-4">
          <div className="flex flex-col gap-2">
            {ruleSections.map((section) => (
              <button
                ...
                className={`flex items-center justify-between p-6 font-black italic text-[11px] uppercase tracking-[0.2em] transition-all transform hover:translate-x-1 border border-white/5 ${
          ...
          <div className="bg-[#111] p-8 border border-white/5 mt-8 shadow-2xl">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <p className="text-gray-600 font-black italic text-[8px] uppercase tracking-[0.3em] mb-1">SƏNƏDİ YÜKLƏ</p>
            ...
            <button className="w-full bg-[#FF4D00] text-black py-4 font-black italic text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-2 hover:bg-white transition-all transform -skew-x-12">
              <span className="transform skew-x-12 flex items-center gap-2">PDF YÜKLƏ <Download size={14} /></span>
            </button>
          </div>
        </div>
