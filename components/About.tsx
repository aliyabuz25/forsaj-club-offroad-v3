    ...
    <div id="haqqımızda" className="bg-[#0A0A0A] text-white">
      ...
      <section className="py-16 px-6 lg:px-20 relative overflow-hidden">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8 mb-20">
          <div className="flex items-start gap-4">
            ...
            <div>
              <TranslatableText
                text={t('aboutTitle', 'HAQQIMIZDA')}
                as="h2"
                className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase leading-none text-white"
              />
              <TranslatableText
                text={t('aboutSubtitle', 'BİZİM HEKAYƏMİZ // MİSSİYAMIZ')}
                as="p"
                className="text-[#FF4D00] font-black italic text-[11px] md:text-sm mt-2 uppercase tracking-[0.4em]"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-7/12 relative z-10">
            <div className="mt-4">
              <TranslatableText
                text={t('about.est_title', 'EST. 2018 // MOTORSPORT MƏRKƏZİ')}
                as="h4"
                className="text-[#FF4D00] font-black italic text-2xl mb-4 tracking-tight"
              />
              <TranslatableText
                text={t('aboutHeroText', 'FORSAJ CLUB AZƏRBAYCANIN OFFROAD MƏDƏNİYYƏTİNİ TƏMSİL EDİR')}
                as="h2"
                className="text-3xl md:text-5xl font-black italic leading-tight mb-8 uppercase max-w-2xl text-white tracking-tighter"
              />
              <TranslatableText
                text={t('aboutDescription', '2018-ci ildən bəri biz Azərbaycanın ən çətin yollarında unudulmaz yarışlar təşkil edirik.')}
                as="p"
              ...
              <div className="flex flex-wrap gap-4">
                {[
                  ...
                  <div key={stat.label} className="bg-[#111] border border-white/5 p-8 rounded-sm min-w-[140px] shadow-2xl">
                    <p className="text-[#FF4D00] font-black italic text-[10px] mb-2 tracking-widest uppercase">
      ...
      <section className="bg-[#050505] py-24 px-6 lg:px-20 text-white relative border-y border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          <div className="relative">
            ...
            <TranslatableText
              text={t('missionTitle', 'BİZİM MİSSİYAMIZ')}
              as="h3"
              className="text-5xl font-black italic mb-8 uppercase tracking-tighter"
            />
            <TranslatableText
              text={t('missionDescription', 'Azərbaycanın hər bir guşəsində offroad idmanını təbliğ etmək və peşəkar pilotlar yetişdirmək.')}
              as="p"
              className="text-gray-400 font-bold italic text-sm leading-relaxed mb-12 max-w-lg uppercase tracking-wide"
            />
            <div className="bg-[#FF4D00] p-5 inline-flex items-center gap-4 transform -skew-x-12 text-black shadow-lg">
              ...
              <span className="font-black italic text-xs transform skew-x-12 uppercase">
                <TranslatableText text={t('targetText', 'HƏDƏFİMİZ: DAKAR RALLİ 2026')} />
              </span>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <TranslatableText
              text={t('visionTitle', 'BİZİM VİZYONUMUZ')}
              as="h3"
              className="text-5xl font-black italic mb-8 uppercase tracking-tighter"
            />
            <TranslatableText
              text={t('visionDescription', 'Azərbaycanın offroad potensialını dünyaya tanıtmaq və beynəlxalq səviyyəli yarış mərkəzi olmaq.')}
              as="p"
              className="text-gray-400 font-bold italic text-sm leading-relaxed mb-12 max-w-lg uppercase tracking-wide"
            />
            <div className="bg-white/5 border border-white/10 p-5 inline-flex items-center gap-4 transform -skew-x-12">
              ...
              <span className="font-black italic text-xs text-white transform skew-x-12 uppercase">
                <TranslatableText text={t('visionGoal', 'QAFQAZIN MOTORSPORT HUBI')} />
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 lg:px-20 bg-[#0A0A0A]">
        <div className="text-center mb-20">
          <TranslatableText
            text={t('valuesHeader', 'BİZİM DƏYƏRLƏRİMİZ')}
            as="h4"
            className="text-[#FF4D00] font-black italic text-[10px] tracking-[0.4em] mb-4 uppercase"
          />
          <TranslatableText
            text={t('valuesTitle', 'NİYƏ FORSAJ CLUB?')}
            as="h2"
            className="text-6xl font-black italic tracking-tighter uppercase leading-none text-white"
          />
        </div>
          ...
          {[
            ...
            <div key={i} className="flex flex-col items-start gap-6 group cursor-default">
              ...
              <TranslatableText
                text={v.title}
                as="h5"
                className="font-black italic text-2xl uppercase tracking-tighter text-white group-hover:text-[#FF4D00] transition-colors"
              />
              <TranslatableText
                text={v.desc}
                as="p"
                className="text-gray-500 font-bold italic text-[10px] uppercase leading-relaxed tracking-widest"
              />
            </div>
          ))}
        </div>
